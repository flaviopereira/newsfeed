...
CREATE TABLE `posts` (
  ...
  `post_privacy` varchar(45) DEFAULT NULL,
  `post_author_name` varchar(45) DEFAULT NULL,
  `post_author_id` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2016-11-18  0:24:58
